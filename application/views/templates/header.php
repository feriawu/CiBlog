    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item <?php echo show_current_class('home'); ?>">

            <a class="nav-link" href="<?php echo base_url(); ?>">Home <span class="sr-only">(current)</span></a>

          </li>

          <li class="nav-item <?php echo show_current_class('about'); ?>">

            <a class="nav-link" href="<?php echo base_url(); ?>about">About</a>

          </li>

          <li class="nav-item <?php echo show_current_class('privacy-policy'); ?>">
          ...
          <li class="nav-item <?php echo show_current_class('categories'); ?>">
